...
public class Khadmat_Kahrba_shamalQahera extends PageBase {

    public Khadmat_Kahrba_shamalQahera(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    public  MobileElement khadmatKahrba;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة شمال القاهرة لتوزيع الكهرباء']")
    public MobileElement daf3ShamalQahera; // Shamal Qahera
    ...
    public void  shamalQaheraUPScreen1 (String CodeNumber)
    {
    ...
    public void  shamalQaheraScreen2 (String  ConfirmationCodeNumber)
    {
