...
public class Khadmat_Kahrba_ganobQahera extends PageBase {
    public Khadmat_Kahrba_ganobQahera(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة جنوب القاهرة لتوزيع الكهرباء']")
    MobileElement daf3GanobQahera; // ganob Qahera
    ...
    public  void  ClickOnGanobQahera ()
    {

        ClickButton(daf3GanobQahera);
    }

    public void  GanobQaheraUPScreen1 (String CodeNumber)
    {
    ...
    public void  GanobQaheraScreen2 (String  ConfirmationCodeNumber)
    {
