...
public class Fawater_Maya_sherktQahera extends PageBase {

    public Fawater_Maya_sherktQahera(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='شركه مياه القاهره']")
    public MobileElement maytQahera;

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركه مياه القاهره']")
    public MobileElement sherktMayaQahera;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 114.2']")
    ...
    public  void  ClickOnMaytQahera()
    {

        ClickButton(maytQahera);
    }

    public  void  ClickOnSherktMaytQahera()
    {

        ClickButton(sherktMayaQahera);
    }
