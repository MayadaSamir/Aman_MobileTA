...
public class Khadmat_Kahrba_Qanah extends PageBase {
    public Khadmat_Kahrba_Qanah(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة القناة لتوزيع الكهرباء']")
    MobileElement daf3Qanah; // el qanah
    ...
    public  void  ClickOnQanah ()
    {

        ClickButton(daf3Qanah);
    }

    public void  QanahUPScreen1 (String CodeNumber)
    {
    ...
    public void  QanahScreen2 (String  ConfirmationCodeNumber)
    {
