...
public class Khadmat_Kahrba_shamalDelta extends PageBase {
    public Khadmat_Kahrba_shamalDelta(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة شمال الدلتا لتوزيع الكهرباء']")
    MobileElement daf3ShamalDelta; // eskndrya
    ...
    public  void  ClickOnShamalDelta ()
    {
        ClickButton(daf3ShamalDelta);
    }

    public void  deltaQaheraUPScreen1 (String CodeNumber)
    {
    ...
    public void  deltaQaheraScreen2 (String  ConfirmationCodeNumber)
    {
