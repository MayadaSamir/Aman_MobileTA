...
public class Khadmat_Kahrba_ganobDelta extends PageBase {
    public Khadmat_Kahrba_ganobDelta(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    MobileElement daf3GanobDelta; // Shamal delta
    ...
    public void  deltaQaheraGanobUPScreen1 (String CodeNumber)
    {
    ...
    public void  deltaQaheraGanobScreen2 (String  ConfirmationCodeNumber)
    {
