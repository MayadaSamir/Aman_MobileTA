...
public class Khadmat_Kahrba_eskndrya extends PageBase {

    public Khadmat_Kahrba_eskndrya(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة الأسكندرية لتوزيع الكهرباء']")
    MobileElement daf3kahrbaEskndrya; // eskndrya
    ...
    public  void  ClickOneskndrya ()
    {

        ClickButton(daf3kahrbaEskndrya);
    }

    public void  eskndryaUPScreen1 (String CodeNumber)
    {
    ...
    public void  eskndryaScreen2 (String  ConfirmationCodeNumber)
    {
