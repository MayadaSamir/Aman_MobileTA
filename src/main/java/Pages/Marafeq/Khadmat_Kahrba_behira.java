...
public class Khadmat_Kahrba_behira extends PageBase {
    public Khadmat_Kahrba_behira(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة البحيرة لتوزيع الكهرباء']")
    MobileElement daf3Behira; // el behira
    ...
    public void  BehiraUPScreen1 (String CodeNumber)
    {
    ...
    public void  BehiraScreen2 (String  ConfirmationCodeNumber)
    {
