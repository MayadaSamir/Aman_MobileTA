...
public class Khadmat_Kahrba_Masr3olya extends PageBase {
    public Khadmat_Kahrba_Masr3olya(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='شركة مصر العليا لتوزيع الكهرباء']")
    MobileElement daf3Masr3olya; // masr el 3olya
    ...
    public  void  ClickOnMasr3olya ()
    {

        ClickButton(daf3Masr3olya);
    }

    public void  Masr3olyaUPScreen1 (String CodeNumber)
    {
    ...
    public void  Masr3olyaScreen2 (String  ConfirmationCodeNumber)
    {
