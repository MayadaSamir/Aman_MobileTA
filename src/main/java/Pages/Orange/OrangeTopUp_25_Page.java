...
public class OrangeTopUp_25_Page extends PageBase {
    public OrangeTopUp_25_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 25.00']")
    public MobileElement Amount25 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 35.75']")
    public MobileElement TotalAmount_35_75 ;
    ...
    public  void Orange_SelectSla25 ()
    {
        ClickButton(Slab25);
    }
    ...
    public void  OrangeFlow (String PIN )
    {
        ...
        System.out.println(Amount25.getText());
        System.out.println(TotalAmount_35_75.getText());
