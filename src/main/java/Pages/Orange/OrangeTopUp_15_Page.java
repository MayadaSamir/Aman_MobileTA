...
public class OrangeTopUp_15_Page extends PageBase {
    public OrangeTopUp_15_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 15.00']")
    public MobileElement Amount15 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 21.45']")
    public MobileElement TotalAmount_21_45 ;
    ...
    public  void Orange_SelectSlab15 ()
    {
        ClickButton(Slab15);
    }
    ...
    public void  OrangeFlow (String PIN ) {
        ...
        System.out.println(Amount15.getText());
        System.out.println(TotalAmount_21_45.getText());
