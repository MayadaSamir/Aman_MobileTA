...
public class OrangeVouchers_15_Page extends PageBase {
    public OrangeVouchers_15_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='15']")
    MobileElement voucher15 ;
    ...
    public MobileElement Voucher_15 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 15.0']")
    public MobileElement TotalValue_15 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher15);
        System.out.println(Amount.getText() + " = " + Voucher_15.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_15.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 15 " + Receipt_footer.getText());
    }
