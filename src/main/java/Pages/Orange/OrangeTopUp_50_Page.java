...
public class OrangeTopUp_50_Page extends PageBase {
    public OrangeTopUp_50_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 50.00']")
    public MobileElement Amount50 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 71.5']")
    public MobileElement TotalAmount_71_5 ;
    ...
    public  void Orange_SelectSla50 ()
    {
        ClickButton(Slab50);
    }
    ...
    public void  OrangeFlow (String PIN )
    {
        ...
        System.out.println(Amount50.getText());
        System.out.println(TotalAmount_71_5.getText());
