...
public class OrangeExtra_3_w_5_Page extends PageBase {
    public OrangeExtra_3_w_5_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='3.5']")
    MobileElement voucher3_w_5  ;
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 3.5']")
    public MobileElement Voucher3_w_5;

    @FindBy(xpath ="//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 3.5']")
    public MobileElement TotalValue3_w_5 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher3_w_5);
        System.out.println(Amount.getText() + " = " + Voucher3_w_5.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue3_w_5.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 3.5 " + Receipt_footer.getText());
    }
