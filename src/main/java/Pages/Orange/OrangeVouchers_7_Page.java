...
public class OrangeVouchers_7_Page extends PageBase {
    public OrangeVouchers_7_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 7.0']")
    public MobileElement Voucher_7 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 7.0']")
    public MobileElement TotalValue_7 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher7);
        System.out.println(Amount.getText() + " = " + Voucher_7.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_7.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 7 " + Receipt_footer.getText());
    }
