...
public class OrangeVouchers_100_Page extends PageBase {
    public OrangeVouchers_100_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Voucher_100 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 100.0']")
    public MobileElement TotalValue_100 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher100);
        System.out.println(Amount.getText() + " = " + Voucher_100.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_100.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 100 " + Receipt_footer.getText());
    }
