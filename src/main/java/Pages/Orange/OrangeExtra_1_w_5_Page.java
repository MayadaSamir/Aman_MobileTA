...
public class OrangeExtra_1_w_5_Page extends PageBase {
    public OrangeExtra_1_w_5_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='1.5']")
    MobileElement voucher1_w_5  ;
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 1.5']")
    public MobileElement Voucher_1_w_5 ;

    @FindBy(xpath ="//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 1.5']")
    public MobileElement TotalValue_1_w_5 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher1_w_5);
        System.out.println(Amount.getText() + " = " + Voucher_1_w_5.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_1_w_5.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 1.5 " + Receipt_footer.getText());
    }
