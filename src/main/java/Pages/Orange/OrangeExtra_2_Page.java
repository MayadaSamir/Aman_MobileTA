...
public class OrangeExtra_2_Page extends PageBase {
    public OrangeExtra_2_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Voucher_2 ;

    @FindBy(xpath ="//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 2.0']")
    public MobileElement TotalValue2 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher2);
        System.out.println(Amount.getText() + " = " + Voucher_2.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue2.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 2 " + Receipt_footer.getText());
    }
