...
public class OrangeVouchers_50_Page extends PageBase {
    public OrangeVouchers_50_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Voucher_50 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 50.0']")
    public MobileElement TotalValue_50 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher50);
        System.out.println(Amount.getText() + " = " + Voucher_50.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_50.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 50 " + Receipt_footer.getText());
    }
