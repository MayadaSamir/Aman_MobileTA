...
public class OrangeTopUp_200_Page extends PageBase {
    public OrangeTopUp_200_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 200.00']")
    public MobileElement Amount200 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 286']")
    public MobileElement TotalAmount_286 ;
    ...
    public  void Orange_SelectSlab200 ()
    {
        ClickButton(Slab200);
    }
    ...
    public void  OrangeFlow (String PIN ) {
        ...
        System.out.println(Amount200.getText());
        System.out.println(TotalAmount_286.getText());
