...
public class OrangeTopUp_5_Page extends PageBase {
    public OrangeTopUp_5_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 5.00']")
    public MobileElement Amount5 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 7.15']")
    public MobileElement TotalAmount7_15 ;
    ...
    public  void Orange_SelectSlab5 ()
    {
        ClickButton(Slab5);
    }
    ...
    public void  OrangeFlow (String PIN )
    {
        ...
        System.out.println(Amount5.getText());
        System.out.println(TotalAmount7_15.getText());
