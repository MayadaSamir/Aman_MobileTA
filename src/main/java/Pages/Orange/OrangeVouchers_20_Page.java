...
public class OrangeVouchers_20_Page extends PageBase {
    public OrangeVouchers_20_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 20.0']")
    public MobileElement Voucher_20 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 20.0']")
    public MobileElement TotalValue_20 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher20);
        System.out.println(Amount.getText() + " = " + Voucher_20.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_20.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 20 " + Receipt_footer.getText());
    }
