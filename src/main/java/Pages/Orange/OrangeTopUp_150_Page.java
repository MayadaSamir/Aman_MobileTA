...
public class OrangeTopUp_150_Page extends PageBase {
    public OrangeTopUp_150_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 150.00']")
    public MobileElement Amount150 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 214.5']")
    public MobileElement TotalAmount_214_5 ;
    ...
    public  void Orange_SelectSlab150 ()
    {
        ClickButton(Slab150);
    }
    ...
    public void  OrangeFlow (String PIN ) {
        ...
        System.out.println(Amount150.getText());
        System.out.println(TotalAmount_214_5.getText());
