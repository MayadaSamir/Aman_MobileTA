...
public class OrangeTopUp_10_Page extends PageBase {
    public OrangeTopUp_10_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 10.00']")
    public MobileElement Amount10 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 14.3']")
    public MobileElement TotalAmount_14_3 ;
    ...
    public  void Orange_SelectSlab10 ()
    {
        ClickButton(Slab10);
    }
    ...
    public void  OrangeFlow (String PIN )
    {
        ...
        System.out.println(Amount10.getText());
        System.out.println(TotalAmount_14_3.getText());
