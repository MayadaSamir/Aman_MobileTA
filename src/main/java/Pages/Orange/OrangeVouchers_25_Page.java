...
public class OrangeVouchers_25_Page extends PageBase {
    public OrangeVouchers_25_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Voucher_25 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 25.0']")
    public MobileElement TotalValue_25 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher25);
        System.out.println(Amount.getText() + " = " + Voucher_25.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_25.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 25 " + Receipt_footer.getText());
    }
