...
public class OrangeVouchers_30_Page extends PageBase {
    public OrangeVouchers_30_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='30']")
    MobileElement voucher30 ;
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 30.0']")
    public MobileElement Voucher_30 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 30.0']")
    public MobileElement TotalValue_30 ;
    ...
    {
        ClickButton(Onecard);
        ClickButton(voucher30);
        System.out.println(Amount.getText() + " = " + Voucher_30.getText());
        System.out.println(TotalAmount.getText() + " = " + TotalValue_30.getText());
    }
    ...
    public  void  orangeVouchers_flow2 (String PIN)
    {
        ...
        System.out.println("Receipt footer for voucher 30 " + Receipt_footer.getText());
    }
