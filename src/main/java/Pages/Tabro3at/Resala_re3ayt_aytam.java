...
public class Resala_re3ayt_aytam extends PageBase {
    public Resala_re3ayt_aytam(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رسالة']")
    public MobileElement resala;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رعاية أيتام']")
    public MobileElement re3aya;
    ...
    public  void ClickOnre3aytAytam()
    { ClickButton(re3aya); }
