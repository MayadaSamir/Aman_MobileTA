...
public class Masr_el_kher_tabro3_shahry extends PageBase {

    public Masr_el_kher_tabro3_shahry(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='تبرع شهرى']")
