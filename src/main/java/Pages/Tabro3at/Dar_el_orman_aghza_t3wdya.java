...
public class Dar_el_orman_aghza_t3wdya extends PageBase {

    public Dar_el_orman_aghza_t3wdya(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='اجهزة تعويضية']")
    public MobileElement aghza;
    ...
    public  void ClickOnAghzaT3wdya()
    { ClickButton(aghza); }
