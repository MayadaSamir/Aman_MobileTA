...
public class Ahl_Masr_tabro3_3am_sadqa extends PageBase {
    public Ahl_Masr_tabro3_3am_sadqa(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='تبرع عام']")
    public MobileElement tabro3;
