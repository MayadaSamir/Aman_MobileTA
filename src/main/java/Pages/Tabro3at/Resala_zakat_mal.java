...
public class Resala_zakat_mal extends PageBase {

    public Resala_zakat_mal(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رسالة']")
    public MobileElement resala;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='زكاة المال']")
    public MobileElement zakatMal;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 8']")
    ...
    public  void ClickOnResala()
    { ClickButton(resala); }

    public  void ClickOnzakatElMal()
    { ClickButton(zakatMal); }
