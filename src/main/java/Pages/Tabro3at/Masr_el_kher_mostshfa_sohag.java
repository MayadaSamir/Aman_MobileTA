...
public class Masr_el_kher_mostshfa_sohag extends PageBase {

    public Masr_el_kher_mostshfa_sohag(AndroidDriver driver) { super(driver); }  //Constructor

    // @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مستشفى سوهاج لعلاج تشوه الوجه والرأس']")
    //public MobileElement tashwh;
    ...
    // public  void ClickOnMostshfaSohag()
    // { ClickButton(tashwh); }
