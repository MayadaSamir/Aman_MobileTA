...
public class Ma3hd_el_awram extends PageBase {

    public Ma3hd_el_awram(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='معهد الأورام 777']")
    public MobileElement ma3hdElAwram;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 9.42']")
    ...
    public  void ClickOnMa3hdElAwram()
    { ClickButton(ma3hdElAwram); }
