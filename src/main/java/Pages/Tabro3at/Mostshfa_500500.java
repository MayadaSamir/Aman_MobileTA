...
public class Mostshfa_500500 extends PageBase {

    public Mostshfa_500500(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='500500']")
    public MobileElement mostshfa500;
    ...
    public  void ClickOn500500()
    { ClickButton(mostshfa500); }
