...
public class Baheya_kashf_mobkr extends PageBase {
    public Baheya_kashf_mobkr(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='كشف مبكر']")
    public MobileElement kashf;
