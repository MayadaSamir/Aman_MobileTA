...
public class Masr_el_kher_khedmt_markz_awram_fayoum extends PageBase {
    public Masr_el_kher_khedmt_markz_awram_fayoum(AndroidDriver driver) { super(driver); }  //Constructor
