...
public class Bank_el_ta3am_el_masry_zakat_el_mal extends PageBase {

    public Bank_el_ta3am_el_masry_zakat_el_mal(AndroidDriver driver) { super(driver); }  //Constructor
