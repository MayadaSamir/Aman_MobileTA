...
public class Dar_el_orman_aytam extends PageBase {

    public Dar_el_orman_aytam(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='ايتام']")
    public MobileElement aytam;
