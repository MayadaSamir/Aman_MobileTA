...
public class Tabeb_el_kher_zakat_mal extends PageBase {
    public Tabeb_el_kher_zakat_mal(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='زكاه مال']")
