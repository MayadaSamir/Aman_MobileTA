...
public class Baheya_ensh2at extends PageBase {
    public Baheya_ensh2at(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='انشاءات']")
