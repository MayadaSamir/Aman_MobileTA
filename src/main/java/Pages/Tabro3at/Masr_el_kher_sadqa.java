...
public class Masr_el_kher_sadqa extends PageBase {

    public Masr_el_kher_sadqa(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مصر الخير صدقة']")
