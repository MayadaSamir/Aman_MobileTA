...
public class Dar_el_orman_mostshfa_shefa_el_orman extends PageBase {

    public Dar_el_orman_mostshfa_shefa_el_orman(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='دار الاورمان']")
    public MobileElement darElorman;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مستشفى شفا الاورمان للسرطان']")
    public MobileElement shefaElOrman;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 2.28']")
    public MobileElement CAFvalue ;

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 8.28']")
    ...
    public  void ClickOnDarElOrman()
    { ClickButton(darElorman); }

    public  void ClickOnMostshfaShefaElOrman()
    { ClickButton(shefaElOrman); }
