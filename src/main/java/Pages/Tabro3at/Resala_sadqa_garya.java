...
public class Resala_sadqa_garya extends PageBase {
    public Resala_sadqa_garya(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رسالة']")
    public MobileElement resala;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='صدقة جارية']")
