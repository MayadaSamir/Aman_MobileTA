...
public class Bank_el_ta3am_el_masry_fedw_sab3 extends PageBase {
    public Bank_el_ta3am_el_masry_fedw_sab3(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='فدو سبع عجل/خروف']")
    public MobileElement fedw;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 3500.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 3502']")
