...
public class Ahl_Masr_3elag_7alat_sadqa extends PageBase {
    public Ahl_Masr_3elag_7alat_sadqa(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='علاج حالات']")
    public MobileElement elagHalat;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='صدقة']")
    public MobileElement sadqa;
