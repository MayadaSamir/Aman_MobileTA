...
public class Bank_el_ta3am_el_masry_taghzya_madrsya extends PageBase {

    public Bank_el_ta3am_el_masry_taghzya_madrsya(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='التغذية المدرسية فئة 155ج']")
    public MobileElement taghzya;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 930.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 932']")
    ...
    public void  numberEntry (String money)
    {
