...
public class Bank_el_kesa2_el_masry_sak_el_batnya extends PageBase {
    public Bank_el_kesa2_el_masry_sak_el_batnya(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='صك البطانية 300ج']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 302']")
