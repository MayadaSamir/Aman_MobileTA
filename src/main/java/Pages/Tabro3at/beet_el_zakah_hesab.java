...
public class beet_el_zakah_hesab extends PageBase {
    public beet_el_zakah_hesab(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='بيت الزكاة والصدقات']")
    public MobileElement beetElzakah;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='حساب وقف (صدقة جارية)']")
    public MobileElement hesab;
    ...
    public  void ClickOnBeetELZakah()
    { ClickButton(beetElzakah); }

    public  void ClickOnHesab()
    { ClickButton(hesab); }
