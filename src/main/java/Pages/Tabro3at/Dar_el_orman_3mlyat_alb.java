...
public class Dar_el_orman_3mlyat_alb extends PageBase {

    public Dar_el_orman_3mlyat_alb(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='عمليات قلب']")
    public MobileElement amlyatAlb;
    ...
    public  void ClickOn3amlyatAlb()
    { ClickButton(amlyatAlb); }
