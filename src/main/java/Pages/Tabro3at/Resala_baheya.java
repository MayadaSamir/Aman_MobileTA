...
public class Resala_baheya extends PageBase {
    public Resala_baheya(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رسالة']")
    public MobileElement resala;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='بهيه']")
