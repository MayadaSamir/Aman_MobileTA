...
public class Sona3_el_hayah_sahm_l7om extends PageBase {

    public Sona3_el_hayah_sahm_l7om(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='400 ج سهم لحوم صدقات (3.5 كيلو)']")
    public MobileElement sahm;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 400.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 405']")
