...
public class Dar_el_orman_3mlyat_3yon extends PageBase {

    public Dar_el_orman_3mlyat_3yon(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='عمليات عيون']")
    public MobileElement amlyat3yon;
    ...
    public  void ClickOn3amlyat3yon()
    { ClickButton(amlyat3yon); }
