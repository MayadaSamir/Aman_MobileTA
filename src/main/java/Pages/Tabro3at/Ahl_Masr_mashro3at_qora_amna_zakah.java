...
public class Ahl_Masr_mashro3at_qora_amna_zakah extends PageBase {
    public Ahl_Masr_mashro3at_qora_amna_zakah(AndroidDriver driver) { super(driver); }  //Constructor
