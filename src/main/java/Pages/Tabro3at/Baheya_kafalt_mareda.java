...
public class Baheya_kafalt_mareda extends PageBase {
    public Baheya_kafalt_mareda(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='كفالة مريضة']")
    public MobileElement mareda;
    ...
    public  void ClickOnKafaltMareda()
    { ClickButton(mareda); }
