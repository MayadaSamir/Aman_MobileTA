...
public class Tabeb_el_kher_3elag_7alat extends PageBase {

    public Tabeb_el_kher_3elag_7alat(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='علاج حالات']")
    public MobileElement elag;
