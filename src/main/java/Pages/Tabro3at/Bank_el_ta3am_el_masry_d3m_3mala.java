...
public class Bank_el_ta3am_el_masry_d3m_3mala extends PageBase {
    public Bank_el_ta3am_el_masry_d3m_3mala(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 960.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 962']")
