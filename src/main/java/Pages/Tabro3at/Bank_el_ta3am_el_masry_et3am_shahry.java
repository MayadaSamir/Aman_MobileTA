...
public class Bank_el_ta3am_el_masry_et3am_shahry extends PageBase {
    public Bank_el_ta3am_el_masry_et3am_shahry(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='اطعام شهرى فئة 120 ج']")
    public MobileElement et3am;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 720.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 722']")
