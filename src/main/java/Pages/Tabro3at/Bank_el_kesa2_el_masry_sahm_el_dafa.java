...
public class Bank_el_kesa2_el_masry_sahm_el_dafa extends PageBase {

    public Bank_el_kesa2_el_masry_sahm_el_dafa(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='سهم الدفا 200ج']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 202']")
