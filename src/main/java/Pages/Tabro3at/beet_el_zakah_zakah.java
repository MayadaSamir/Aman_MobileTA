...
public class beet_el_zakah_zakah extends PageBase {
    public beet_el_zakah_zakah(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='زكاه']")
