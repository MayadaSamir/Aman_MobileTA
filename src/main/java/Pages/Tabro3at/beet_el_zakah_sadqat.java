...
public class beet_el_zakah_sadqat extends PageBase {

    public beet_el_zakah_sadqat(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='الصدقات']")
    public MobileElement sadqat;
