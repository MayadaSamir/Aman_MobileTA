...
public class Resala_7alat_7arga extends PageBase {
    public Resala_7alat_7arga(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رسالة']")
    public MobileElement resala;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='حالات حرجه']")
    public MobileElement halat;
    ...
    public  void ClickOn7alat7arega()
    { ClickButton(halat); }
