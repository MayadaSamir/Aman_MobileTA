...
public class Bank_el_kesa2_el_masry extends PageBase {
    public Bank_el_kesa2_el_masry(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='بنك الكساء المصري']")
    public MobileElement bank;
