...
public class Bank_el_ta3am_el_masry_sadqa_garya  extends PageBase {

    public Bank_el_ta3am_el_masry_sadqa_garya(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='صدقة جارية']")
    public MobileElement sadqaGarya;
