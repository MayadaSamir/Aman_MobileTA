...
public class Mostshfa_333 extends PageBase {

    public Mostshfa_333(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مستشفى333 لامراض الجهاز الهضمي']")
    public MobileElement mostshfa333;
    ...
    public  void ClickOnMostshfa333()
    { ClickButton(mostshfa333); }
