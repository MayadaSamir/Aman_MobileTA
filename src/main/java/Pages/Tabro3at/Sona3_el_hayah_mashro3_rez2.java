...
public class Sona3_el_hayah_mashro3_rez2 extends PageBase {

    public Sona3_el_hayah_mashro3_rez2(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مشروع رزق حلال']")
    public MobileElement mashro3Rez2;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 9']")
    ...
    public  void ClickOnMashro3()
    { ClickButton(mashro3Rez2); }
