...
public class Bank_el_ta3am_el_masry_l7om extends PageBase {

    public Bank_el_ta3am_el_masry_l7om(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 1200.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 1202']")
