...
public class Ahl_Masr_ensh2at_mostshfa_zakah extends PageBase {
    public Ahl_Masr_ensh2at_mostshfa_zakah(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='إنشاءات المستشفى']")
    public MobileElement ensh2at;
