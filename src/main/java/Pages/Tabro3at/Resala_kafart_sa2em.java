...
public class Resala_kafart_sa2em extends PageBase {
    public Resala_kafart_sa2em(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='رسالة']")
    public MobileElement resala;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='كفارة صائم']")
    public MobileElement kafara;
    ...
    public  void ClickOnKafartSa2em()
    { ClickButton(kafara); }
