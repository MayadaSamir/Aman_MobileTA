...
public class El_helal_el_ahmar_da3m_bayrot extends PageBase {

    public El_helal_el_ahmar_da3m_bayrot(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='دعم بيروت']")
    public MobileElement bayrot;
