...
public class Ahl_Masr_mashro3at_qora_amna_sadqa extends PageBase {
    public Ahl_Masr_mashro3at_qora_amna_sadqa(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مشروعات قرى آمنة']")
    public MobileElement qora;
