...
public class Sona3_el_hayah_sak_baldy extends PageBase {

    public Sona3_el_hayah_sak_baldy(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='صك بلدي كبير 3600 ج']")
    public MobileElement sak;

    @FindBy(id = "popup_name")
    public MobileElement mobileTitle;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='3600']")
    public MobileElement Moneyslab;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 3600.0']")
    public MobileElement AmountVALUE ;

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 5.00']")
    public MobileElement CAFvalue ;

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 3605']")
