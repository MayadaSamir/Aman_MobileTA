...
public class Masr_el_kher_tarmem_sa2f_manzl extends PageBase {
    public Masr_el_kher_tarmem_sa2f_manzl(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مصر الخير ترميم سقف منزل']")
    public MobileElement tarmem;
