...
public class Ahl_Masr_3elag_7alat_zakah extends PageBase {
    public Ahl_Masr_3elag_7alat_zakah(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='علاج حالات']")
    public MobileElement elagHalat;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='زكاة']")
    public MobileElement zakah;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 15.0']")
    public MobileElement AmountVALUE ;

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 3.00']")
    public MobileElement CAFvalue ;

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 18']")
    ...
    public  void ClickOn3elag7alat()
    { ClickButton(elagHalat); }

    public  void ClickOnZakah()
    { ClickButton(zakah); }
