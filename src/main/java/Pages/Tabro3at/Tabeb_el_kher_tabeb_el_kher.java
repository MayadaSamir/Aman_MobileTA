...
public class Tabeb_el_kher_tabeb_el_kher extends PageBase {

    public Tabeb_el_kher_tabeb_el_kher(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='طبيب الخير']")
    public MobileElement tabebElKher;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 10.56']")
    ...
    public  void ClickOnTabebElKher()
    { ClickButton(tabebElKher); }
