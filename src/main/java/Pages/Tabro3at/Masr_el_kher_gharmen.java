...
public class Masr_el_kher_gharmen extends PageBase {

    public Masr_el_kher_gharmen(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مصر الخير غارمين']")
