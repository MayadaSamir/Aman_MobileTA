...
public class Bank_el_kesa2_el_masry_defa2_sheta extends PageBase {
    public Bank_el_kesa2_el_masry_defa2_sheta(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='شنطة دفاء الشتاء 700ج']")
    public MobileElement defa2;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 700.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 702']")
