...
public class WE_KrotSha7n_kartGomla_100 extends PageBase {
    public WE_KrotSha7n_kartGomla_100(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    MobileElement WeVoucher_100; //slab 100
    ...
    public MobileElement TotalAmount100_0;
    ...
    public void  WEKrotFlow (String PIN )
    {
        ...
        System.out.println(TotalAmount100_0.getText());
