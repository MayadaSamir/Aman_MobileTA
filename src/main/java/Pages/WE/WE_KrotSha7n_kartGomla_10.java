...
public class WE_KrotSha7n_kartGomla_10 extends PageBase {

    public WE_KrotSha7n_kartGomla_10(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    MobileElement WeVoucher_10; //slab 10
    ...
    public MobileElement Amount10_0;

    @FindBy(id = "fees_value")
    public MobileElement TotalAmount10_0;
    ...
    public void  WEVoucher_slab_10()
    {
        ClickButton(WeVoucher_10);
    }
    ...
    public void  WEKrotFlow (String PIN )
    {
        ...
        System.out.println(Amount10_0.getText());
        System.out.println(TotalAmount10_0.getText());
