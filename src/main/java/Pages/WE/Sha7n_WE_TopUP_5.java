...
public class Sha7n_WE_TopUP_5 extends PageBase {
    public Sha7n_WE_TopUP_5(AndroidDriver driver) {
        super(driver);
    }

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'sub_service_name_tv') and @text='شحن وي']")
   public MobileElement WETopUp;
    ...
    public MobileElement TotalAmount5;
    ...
    public  void  WE_EnterSlab5 ()
    {
        ClickButton(Slab5_300);
    }

    public void  WETopUpScreen3 (String  EnterAmount5)
    {
        System.out.println(AmountEntryScreenTitle.getText());
        SetTextElement(EnterAmount , EnterAmount5);
    ...
    public void WEFlow (String PIN ) {
        ...
        System.out.println(TotalAmount5.getText());
