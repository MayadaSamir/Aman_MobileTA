...
public class Sha7n_WE_TopUP_300 extends PageBase {

    public Sha7n_WE_TopUP_300(AndroidDriver driver) { super(driver);}
    ...
    public MobileElement Amount300_0;

    @FindBy(id = "fees_value")
    public MobileElement TotalAmount300;
    ...
    public  void  WE_EnterSlab300 ()
    {

        ClickButton(Slab300);
    }

    public void  WETopUpScreen3 (String  EnterAmount300)
    {
        System.out.println(AmountEntryScreenTitle.getText());
        SetTextElement(EnterAmount , EnterAmount300);
    ...
    public void WEFlow (String PIN ) {
        ...
        System.out.println(Amount300_0.getText());
        System.out.println(TotalAmount300.getText());
