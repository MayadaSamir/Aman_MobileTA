...
public class XPay extends PageBase {

    public XPay(AndroidDriver driver) { super(driver); }  //Constructor

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='مدفوعات اكس باي']")
    public MobileElement xpay;

    @FindBy(id = "popup_name")
    public MobileElement codeTitle;

    @FindBy (id = "user_input_edit")
    MobileElement EnterNumber;  //221406130
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 52.85']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 58.550000000000004']")
