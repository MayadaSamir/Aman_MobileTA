...
public class Gam3t_elsadat extends PageBase {
    public Gam3t_elsadat(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة السادات']")
    //public MobileElement gam3telSadat; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnGam3telSadat ()
    {

        ClickButton(gam3telSadat);
    }*/
