...
public class Gam3at_domyat extends PageBase {
    public Gam3at_domyat(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    //@FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة دمياط']")
    //public MobileElement gam3tDomyat; //  akadmyt el fnon uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnGam3tDomyat ()
    {

        ClickButton(gam3tDomyat);
    }*/
