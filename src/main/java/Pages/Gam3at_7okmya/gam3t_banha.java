...
public class gam3t_banha extends PageBase {
    public  gam3t_banha(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    //public MobileElement gam3tBanha; //  akadmyt el fnon uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOngam3tBanha ()
    {

        ClickButton(gam3tBanha);
    }*/
