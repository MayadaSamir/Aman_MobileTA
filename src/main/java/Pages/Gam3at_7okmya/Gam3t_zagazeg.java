...
public class Gam3t_zagazeg extends PageBase {
    public Gam3t_zagazeg(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة الزقازيق']")
    //public MobileElement gam3tZagazeg; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnGam3tZagazeg ()
    {

        ClickButton(gam3tZagazeg);
    }*/
