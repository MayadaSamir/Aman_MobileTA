...
public class Gam3t_eskndrya extends PageBase {
    public Gam3t_eskndrya (AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة الأسكندرية']")
    public MobileElement gam3tEleskndrya; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    public  void  ClickOnGam3teskndrya ()
    {

        ClickButton(gam3tEleskndrya);
    }
