...
public class Gam3t_el_Qahera extends PageBase {

    public Gam3t_el_Qahera(AndroidDriver driver) {
        super(driver);
    }  //Constructor

    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'normal_service_tv') and @text='الجامعات الحكومية']")   //choose khadmat kahrba screen
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة القاهرة']")
    public MobileElement gam3tElQahera; //  Qahera uni slab
    ...
    public  void  ClickOnGam3tQahera ()
    {

        ClickButton(gam3tElQahera);
    }
