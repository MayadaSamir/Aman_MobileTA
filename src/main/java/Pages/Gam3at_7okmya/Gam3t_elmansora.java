...
public class Gam3t_elmansora extends PageBase {
    public Gam3t_elmansora(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة المنصورة']")
    //public MobileElement gam3telMansora; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnGam3telMansora ()
    {

        ClickButton(gam3telMansora);
    }*/
