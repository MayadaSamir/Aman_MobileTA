...
public class Gam3t_qanat_elswes extends PageBase {
    public Gam3t_qanat_elswes(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة قناة السويس']")
    public MobileElement gam3tQanatSwes; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    public  void  ClickOnGam3tQanatSwes ()
    {

        ClickButton(gam3tQanatSwes);
    }
