...
public class Gam3t_elmonfya extends PageBase {

    public Gam3t_elmonfya(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='أكاديمية الفنون']")
    //public MobileElement gam3tElMonfya; //  akadmyt el fnon uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOngam3tElMonfya ()
    {

        ClickButton(gam3tElMonfya);
    }*/
