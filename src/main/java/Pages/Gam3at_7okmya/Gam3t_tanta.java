...
public class Gam3t_tanta extends PageBase {
    public Gam3t_tanta(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة طنطا']")
    //public MobileElement gam3tTanta; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnGam3tTanta ()
    {

        ClickButton(gam3tTanta);
    }*/
