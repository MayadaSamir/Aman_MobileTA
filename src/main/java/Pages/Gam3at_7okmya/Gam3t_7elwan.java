...
public class Gam3t_7elwan extends PageBase {
    public Gam3t_7elwan(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة حلوان']")
    public MobileElement gam3t7elwan; //  gam3t 7elwan uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    public  void  ClickOngam3t7elwan ()
    {

        ClickButton(gam3t7elwan);
    }
