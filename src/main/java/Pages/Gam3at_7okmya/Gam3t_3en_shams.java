...
public class Gam3t_3en_shams extends PageBase {
    public Gam3t_3en_shams(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة عين شمس']")
    public MobileElement gam3t3enShams; //  3en shams uni slab
