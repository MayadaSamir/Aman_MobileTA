...
public class Gam3t_eskndrya_far3_matro7 extends PageBase {
    public Gam3t_eskndrya_far3_matro7(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة الأسكندرية- فرع مطروح']")
    public MobileElement gam3tEskndryaMatro7; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    public  void  ClickOnGam3EskndryaMatro7 ()
    {

        ClickButton(gam3tEskndryaMatro7);
    }
