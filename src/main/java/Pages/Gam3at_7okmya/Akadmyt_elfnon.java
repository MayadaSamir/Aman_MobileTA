...
public class Akadmyt_elfnon extends PageBase {

    public Akadmyt_elfnon(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    //public MobileElement Akadmytelfnon; //  akadmyt el fnon uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnAkadmytelFnon ()
    {

        ClickButton(Akadmytelfnon);
    }*/
