...
public class Gam3t_ganob_elwady extends PageBase {

    public Gam3t_ganob_elwady(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة جنوب الوادي']")
    public MobileElement gam3tGanobElWady; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    public  void  ClickOnGam3tGanobElWady ()
    {

        ClickButton(gam3tGanobElWady);
    }
