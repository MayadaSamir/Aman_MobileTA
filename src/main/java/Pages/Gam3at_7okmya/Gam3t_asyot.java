...
public class Gam3t_asyot extends PageBase {
    public Gam3t_asyot(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة أسيوط']")
    //public MobileElement gam3tAsyot; //  akadmyt el fnon uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOngam3tAsyot ()
    {

        ClickButton(gam3tAsyot);
    }*/
