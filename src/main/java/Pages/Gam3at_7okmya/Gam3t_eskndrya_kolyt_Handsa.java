...
public class Gam3t_eskndrya_kolyt_Handsa extends PageBase {
    public Gam3t_eskndrya_kolyt_Handsa(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة الأسكندرية- كلية الهندسة']")
    public MobileElement gam3tEskndryaHandsa; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    public  void  ClickOnGam3tEskndryaHandsa ()
    {

        ClickButton(gam3tEskndryaHandsa);
    }
