...
public class Gam3t_sohag extends PageBase {
    public Gam3t_sohag(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    // @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='جامعة سوهاج']")
    //public MobileElement gam3tSohag; //  3en shams uni slab
   ...
   /* public  void  ClickOnGam3at7okmya ()
    ...
    /*public  void  ClickOnGam3tSohag ()
    {

        ClickButton(gam3tSohag);
    }*/
