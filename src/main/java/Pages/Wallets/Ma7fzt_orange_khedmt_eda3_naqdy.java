...
public class Ma7fzt_orange_khedmt_eda3_naqdy extends PageBase {

    public Ma7fzt_orange_khedmt_eda3_naqdy(AndroidDriver driver) {
        super(driver);
    }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='خدمة ايداع نقدي']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 12.0']")
