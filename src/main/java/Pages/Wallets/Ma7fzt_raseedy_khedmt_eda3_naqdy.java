...
public class Ma7fzt_raseedy_khedmt_eda3_naqdy extends PageBase {

    public Ma7fzt_raseedy_khedmt_eda3_naqdy(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'service_name') and @text='خدمة إيداع نقدي']")
    public MobileElement khedmtEda3; //inside screen
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 56.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 56.0']")
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='56.0']")
