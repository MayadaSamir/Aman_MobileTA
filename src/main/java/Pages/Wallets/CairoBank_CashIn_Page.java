...
public class CairoBank_CashIn_Page extends PageBase {
    public CairoBank_CashIn_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 8.0']")
