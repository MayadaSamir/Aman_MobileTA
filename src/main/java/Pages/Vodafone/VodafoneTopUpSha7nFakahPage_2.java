...
public class VodafoneTopUpSha7nFakahPage_2 extends PageBase {
    public VodafoneTopUpSha7nFakahPage_2(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 2']")
    public MobileElement Amount2 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 2']")
    public MobileElement TotalAmount2 ;
    ...
    public  void  VFSha7nFakahConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        System.out.println(VfTopUpAmount.getText() + " = " + Amount2.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount2.getText());
    }
