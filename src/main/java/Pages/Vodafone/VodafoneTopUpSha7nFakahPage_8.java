...
public class VodafoneTopUpSha7nFakahPage_8 extends PageBase {
    public VodafoneTopUpSha7nFakahPage_8(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='8']")
    MobileElement Slab8 ;
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 8']")
    public MobileElement Amount8;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 8']")
    public MobileElement TotalAmount8;
    ...
    public  void  VFSha7nFakahConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        System.out.println(VfTopUpAmount.getText() + " = " + Amount8.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount8.getText());
    }
