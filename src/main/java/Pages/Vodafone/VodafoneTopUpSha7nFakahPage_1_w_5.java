...
public class VodafoneTopUpSha7nFakahPage_1_w_5 extends PageBase {
    public VodafoneTopUpSha7nFakahPage_1_w_5(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  VFSha7nFakahConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        ClickButton(Slab1_w_5);
        System.out.println(Title.getText());
        System.out.println(VfTopUpAmount.getText() + " = " + Amount1_w_5.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount1_w_5.getText());
    }
