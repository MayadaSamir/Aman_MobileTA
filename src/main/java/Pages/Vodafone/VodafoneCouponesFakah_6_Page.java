...
public class VodafoneCouponesFakah_6_Page extends PageBase {
    public VodafoneCouponesFakah_6_Page(AndroidDriver driver) {
        super(driver);
    }
