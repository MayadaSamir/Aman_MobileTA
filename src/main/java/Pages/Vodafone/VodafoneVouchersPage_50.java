...
public class VodafoneVouchersPage_50 extends PageBase {
    public VodafoneVouchersPage_50(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement TotalAmount50_00 ;
    ...
    public void  VFVoucher_50_Select  () {

        ClickButton(OneCard);
        ClickButton(VFVoucher_50_00);
        ...
        System.out.println(TotalAmount50_00.getText());
    }
