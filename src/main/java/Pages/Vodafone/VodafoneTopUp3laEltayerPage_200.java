...
public class VodafoneTopUp3laEltayerPage_200 extends PageBase {
    public VodafoneTopUp3laEltayerPage_200(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 285.72']")
    public MobileElement TotalAmount285_72;
    ...
    public  void  ConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        System.out.println(VfTopUpAmount.getText() + " = " + Amount200.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount285_72.getText());
    }
