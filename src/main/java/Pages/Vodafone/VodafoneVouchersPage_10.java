...
public class VodafoneVouchersPage_10 extends PageBase {
    public VodafoneVouchersPage_10(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement TotalAmount10_00 ;
    ...
    public  void VfVouchers ()
    {
        ClickButton(VfVouchersService);
    }

    public void  VFVoucher_10_Select  () {
        ClickButton(OneCard);
        ClickButton(VFVoucher_10_00);
        ...
        System.out.println(TotalAmount10_00.getText());
    }
