...
public class VodafoneCouponesFakah_4_Page extends PageBase {
    public VodafoneCouponesFakah_4_Page(AndroidDriver driver) {
        super(driver);
    }
