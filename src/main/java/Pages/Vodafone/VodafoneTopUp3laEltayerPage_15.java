...
public class VodafoneTopUp3laEltayerPage_15  extends PageBase {
    public VodafoneTopUp3laEltayerPage_15(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Amount15 ;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 21.43']")
    public MobileElement TotalAmount21_43 ;
    ...
    public  void  ConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        System.out.println(VfTopUpAmount.getText() + " = " + Amount15.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount21_43.getText());
    }
