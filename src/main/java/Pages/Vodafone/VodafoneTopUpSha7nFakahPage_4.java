...
public class VodafoneTopUpSha7nFakahPage_4 extends PageBase {
    public VodafoneTopUpSha7nFakahPage_4(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='4']")
    MobileElement Slab4 ;
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text= 'EGP 4']")
    public MobileElement Amount4;

    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 4']")
    public MobileElement TotalAmount4 ;
    ...
    public  void  VFSha7nFakahConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        System.out.println(VfTopUpAmount.getText() + " = " + Amount4.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount4.getText());
    }
