...
public class VodafoneBillPayment_Full_paymentPage extends PageBase {
    public VodafoneBillPayment_Full_paymentPage(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='دفع القيمة كاملة']")
     public MobileElement full_payment_option ;
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'total_amount_value') and @text='EGP 7.0']")
    ...
    public void  Flow_Screen2 (String  ConRefNumber)
    {
        ...
        System.out.println(full_payment_option.getText());
    }

    public void  fullpayment ()
    {
        ClickButton(full_payment_option);
