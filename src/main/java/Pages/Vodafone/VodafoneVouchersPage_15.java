...
public class VodafoneVouchersPage_15 extends PageBase {
    public VodafoneVouchersPage_15(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement TotalAmount15_00 ;
    ...
    public void  VFVoucher_15_Select  ()
    {
        ClickButton(OneCard);
        ClickButton(VFVoucher_15_00);
        ...
        System.out.println(TotalAmount15_00.getText());
    }
