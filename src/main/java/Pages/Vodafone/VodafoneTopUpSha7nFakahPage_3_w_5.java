...
public class VodafoneTopUpSha7nFakahPage_3_w_5 extends PageBase {
    public VodafoneTopUpSha7nFakahPage_3_w_5(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  VFSha7nFakahConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        ClickButton(Slab3_w_5);
        System.out.println(Title.getText());
        System.out.println(VfTopUpAmount.getText() + " = " + Amount3_w_5.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount3_w_5.getText());
    }
