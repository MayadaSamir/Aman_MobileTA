...
public class VodafoneCouponesFakah_8_Page extends PageBase {
    public VodafoneCouponesFakah_8_Page(AndroidDriver driver) {
        super(driver);
    }
