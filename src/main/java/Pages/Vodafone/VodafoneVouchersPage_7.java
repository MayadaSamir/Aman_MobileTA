...
public class VodafoneVouchersPage_7 extends PageBase {
    public VodafoneVouchersPage_7(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Amount7 ;

    @FindBy(id = "fees_value")
    public MobileElement TotalAmount7_00 ;
    ...
    public void  VFVoucher_7_Select  ()
    {
        ClickButton(OneCard);
        ClickButton(VFVoucher_7_00);
        System.out.println(VfVoucherAmount.getText());
        System.out.println(VfVoucherTotalAmount.getText());
        System.out.println(Amount7.getText());
        System.out.println(TotalAmount7_00.getText());
    }
