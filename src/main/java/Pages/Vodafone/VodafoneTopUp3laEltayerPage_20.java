...
public class VodafoneTopUp3laEltayerPage_20 extends PageBase {
    public VodafoneTopUp3laEltayerPage_20(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'fees_value') and @text='EGP 28.57']")
    public MobileElement TotalAmount28_57 ;
    ...
    public  void  ConfirmationMobileNumberScreen2 (String ConfirmationMob)
    {
        ...
        System.out.println(VfTopUpAmount.getText() + " = " + Amount20.getText());
        System.out.println(VfTopUpTotalAmount.getText() + " = " + TotalAmount28_57.getText());
    }
