...
public class VodafoneVouchersPage_25 extends PageBase {
    public VodafoneVouchersPage_25(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement TotalAmount25_00 ;
    ...
    public void  VFVoucher_25_Select  () {
        ClickButton(OneCard);
        ClickButton(VFVoucher_25_00);
        ...
        System.out.println(TotalAmount25_00.getText());
    }
