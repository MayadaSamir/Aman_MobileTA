...
public class Etisalat_Akwa_Kart_fe_Misr_Social_media_5_page extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_Social_media_5_page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='5.0']")
    public MobileElement Slab_5;
