...
public class EtisalatTopUp_Page_15 extends PageBase {
    public EtisalatTopUp_Page_15(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab15 ()
    {
        ClickButton(Slab15);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount21_43.getText());
