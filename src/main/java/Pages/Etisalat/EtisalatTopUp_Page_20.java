...
public class EtisalatTopUp_Page_20
extends PageBase {
    public EtisalatTopUp_Page_20(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab20 ()
    {
        ClickButton(Slab20);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount28_57.getText());
