...
public class Etisalat_Akwa_Kart_fe_Baqet_video_3_5_Page extends PageBase {
    public Etisalat_Akwa_Kart_fe_Baqet_video_3_5_Page(AndroidDriver driver) {
        super(driver);
    }
