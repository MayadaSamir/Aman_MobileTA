...
public class EtisalatTopUp_Page_30 extends PageBase {
    public EtisalatTopUp_Page_30(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Amount30;

    @FindBy(id = "fees_value")
    public MobileElement TotalAmount42_86 ;
    ...
    public  void  Etisalat_SelectSlab30 ()
    {
        ClickButton(Slab30);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(Amount30.getText());
        System.out.println(TotalAmount42_86.getText());
