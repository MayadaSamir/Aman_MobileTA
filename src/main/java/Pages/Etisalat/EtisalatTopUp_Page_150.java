...
public class EtisalatTopUp_Page_150 extends PageBase {
    public EtisalatTopUp_Page_150(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement TotalAmount214_29 ;
    ...
    public  void  Etisalat_SelectSlab150 ()
    {
        ClickButton(Slab150);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount214_29.getText());
