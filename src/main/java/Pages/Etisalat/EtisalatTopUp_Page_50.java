...
public class EtisalatTopUp_Page_50 extends PageBase {
    public EtisalatTopUp_Page_50(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab50 ()
    {
        ClickButton(Slab50);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount71_43.getText());
