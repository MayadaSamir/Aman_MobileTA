...
public class Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_9_page extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_9_page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='9']")
