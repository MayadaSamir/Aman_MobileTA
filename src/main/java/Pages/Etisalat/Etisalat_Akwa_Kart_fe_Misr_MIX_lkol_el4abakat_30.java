...
public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_30 extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_30(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='30.0']")
