...
public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_50 extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_50(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='50.0']")
