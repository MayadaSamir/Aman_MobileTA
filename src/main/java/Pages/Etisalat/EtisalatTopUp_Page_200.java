...
public class EtisalatTopUp_Page_200 extends PageBase {
    public EtisalatTopUp_Page_200(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab200 ()
    {
        ClickButton(Slab200);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount285_72.getText());
