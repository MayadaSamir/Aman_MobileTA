...
public class Etisalat_Akwa_Kart_fe_Misr_Social_media_9_page extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_Social_media_9_page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 9.0']")
