...
public class EtisalatTopUp_Page_10 extends PageBase {

    public EtisalatTopUp_Page_10(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab10 ()
    {
        ClickButton(Slab10);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount14_29.getText());
