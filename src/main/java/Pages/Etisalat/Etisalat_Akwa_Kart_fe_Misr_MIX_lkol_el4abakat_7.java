...
public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_7 extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_7(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 7.00']")
