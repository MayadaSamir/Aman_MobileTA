...
public class Etisalat_Akwa_Kart_fe_Baqet_video_15_Page extends PageBase {
    public Etisalat_Akwa_Kart_fe_Baqet_video_15_Page(AndroidDriver driver) {
        super(driver);}
    ...
    @FindBy (xpath = "//android.widget.TextView[contains(@resource-id,'amount_value') and @text='EGP 15']")
