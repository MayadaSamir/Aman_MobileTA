...
public class EtisalatTopUp_Page_250 extends PageBase {
    public EtisalatTopUp_Page_250(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy (xpath= "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='250']")
    MobileElement Slab250;
    ...
    public MobileElement Amount250;

    @FindBy(id = "fees_value")
    public MobileElement TotalAmount357_15 ;
    ...
    public  void  Etisalat_SelectSlab250 ()
    {
        ClickButton(Slab250);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(Amount250.getText());
        System.out.println(TotalAmount357_15.getText());
