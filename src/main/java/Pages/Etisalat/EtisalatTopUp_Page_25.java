...
public class EtisalatTopUp_Page_25 extends PageBase {
    public EtisalatTopUp_Page_25(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab25 ()
    {
        ClickButton(Slab25);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount35_72.getText());
