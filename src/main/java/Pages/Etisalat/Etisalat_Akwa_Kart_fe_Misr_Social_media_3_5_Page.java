...
public class Etisalat_Akwa_Kart_fe_Misr_Social_media_3_5_Page extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_Social_media_3_5_Page(AndroidDriver driver) {
        super(driver);
    }
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'sub_service_name_tv') and @text='أقوى كارت في مصر سوشيال ميديا']")
    ...
    public MobileElement Slab_3_w_5;
