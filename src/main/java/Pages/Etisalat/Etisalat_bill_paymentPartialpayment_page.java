...
public class Etisalat_bill_paymentPartialpayment_page extends PageBase {
    public Etisalat_bill_paymentPartialpayment_page(AndroidDriver driver) {
        super(driver);
    }
    ...
    public MobileElement Partialpayment;
    ...
    public void  Flow_Screen2 (String  ConRefNumber)
    {
        ...
        System.out.println(Partialpayment.getText());
    }

    public void  Partialpayment ( String amount)
    {
        ClickButton(Partialpayment);
