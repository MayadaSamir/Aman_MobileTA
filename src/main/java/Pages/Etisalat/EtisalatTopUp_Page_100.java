...
public class EtisalatTopUp_Page_100 extends PageBase {
    public EtisalatTopUp_Page_100(AndroidDriver driver) {
        super(driver);
    }
    ...
    public  void  Etisalat_SelectSlab100 ()
    {
        ClickButton(Slab100);
    }
    ...
    public void EtislatFlow (String PIN ) {
        ...
        System.out.println(TotalAmount142_86.getText());
