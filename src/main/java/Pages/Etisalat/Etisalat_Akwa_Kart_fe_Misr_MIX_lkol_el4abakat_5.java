...
public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_5 extends PageBase {
    public Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_5(AndroidDriver driver) {
        super(driver);
    }
