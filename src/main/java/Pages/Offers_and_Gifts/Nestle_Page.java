...
public class Nestle_Page extends PageBase {
    public Nestle_Page(AndroidDriver driver) {
        super(driver);
    }

    @FindBy(xpath ="//android.widget.TextView[contains(@resource-id,'service_name') and @text='نستله']")
    public MobileElement Nestle_Service ;

    @FindBy(xpath ="//android.widget.TextView[contains(@resource-id,'service_name') and @text='الكل كسبان']")
    public MobileElement Kol_Kasban_Service ;

    public  void  ClickOnNestleService ()
    {
        ClickButton(Nestle_Service);
        ClickButton(Kol_Kasban_Service);
    }
