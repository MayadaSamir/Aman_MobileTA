...
public class Eshtrkat_CNE_mafo3at_mobashra extends PageBase {
    public Eshtrkat_CNE_mafo3at_mobashra(AndroidDriver driver) { super(driver); }  //Constructor
    ...
    @FindBy(xpath = "//android.widget.TextView[contains(@resource-id,'amount_text_view_card') and @text='مدفوعات مباشرة']")
    public MobileElement madfo3atSlab;
    ...
    public  void ClickOnMadfo3at()
    { ClickButton(madfo3atSlab); }
