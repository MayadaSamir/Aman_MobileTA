...
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_50_page;
import Tests.TestBase;
import org.testng.Assert;
import org.testng.annotations.Test;

public class Etisalat_Akwa_Kart_d2aye2_lkol_el4abakat_50_Test  extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_50_page EtisalatDayaye2;

    @Test
    public void Etisalat_Akwa_Kart_fe_Misr_d2aye2_30() throws Exception
    {
        try {
            EtisalatDayaye2 = new Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_50_page(driver);
            ...
            Assert.assertEquals(EtisalatDayaye2.AmountVALUE.getText(), "EGP 50.0");
            Assert.assertEquals(EtisalatDayaye2.Totalvalue.getText(), "EGP 50.0");
