...
public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_30_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_30 Etisalat;

    @Test
    public void Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_30() throws Exception
    {
        try {
            Etisalat = new Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_30(driver);
            ...
            Assert.assertTrue(Etisalat.AmountVALUE.getText().contains("30"));
            Assert.assertTrue(Etisalat.Totalvalue.getText().contains("30"));
            Etisalat.flow("0000");
