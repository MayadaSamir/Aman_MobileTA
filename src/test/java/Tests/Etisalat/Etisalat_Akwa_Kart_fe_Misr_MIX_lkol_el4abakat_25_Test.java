...
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_15;
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_25;
import Tests.TestBase;
import org.testng.Assert;
import org.testng.annotations.Test;

public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_25_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_25
            Etisalat;

    @Test
    public void Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_25()  throws  Exception
    {
        try {
        Etisalat = new Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_25  (driver);
        ...
        Assert.assertTrue(Etisalat.AmountVALUE.getText().contains("25"));
        Assert.assertTrue(Etisalat.Totalvalue.getText().contains("25"));
        Etisalat.flow("0000");
