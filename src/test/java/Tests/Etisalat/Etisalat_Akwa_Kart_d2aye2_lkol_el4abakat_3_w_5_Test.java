...
public class Etisalat_Akwa_Kart_d2aye2_lkol_el4abakat_3_w_5_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_3_5_Page  EtisalatDayaye2 ;

    @Test
    public  void   Etisalat_Akwa_Kart_fe_Misr_d2aye2_3_5 () throws Exception
    {
        try {
            EtisalatDayaye2 = new Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_3_5_Page(driver);
            ...
            Assert.assertEquals(EtisalatDayaye2.AmountVALUE.getText(), "EGP 3.5");
            Assert.assertEquals(EtisalatDayaye2.Totalvalue.getText(), "EGP 3.5");
