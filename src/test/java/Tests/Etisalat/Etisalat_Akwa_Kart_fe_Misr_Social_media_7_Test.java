...
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_Social_media_5_page;
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_Social_media_7_page;
import Tests.TestBase;
import org.testng.Assert;
import org.testng.annotations.Test;

public class Etisalat_Akwa_Kart_fe_Misr_Social_media_7_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_Social_media_7_page Etisalat;

    @Test
    public void Etisalat_Akwa_Kart_fe_Misr_social_media_5()  throws  Exception
    {
        try {
            Etisalat = new Etisalat_Akwa_Kart_fe_Misr_Social_media_7_page(driver);
            ...
            Assert.assertTrue(Etisalat.AmountVALUE.getText().contains("7"));
            Assert.assertTrue(Etisalat.Totalvalue.getText().contains("7"));
            Etisalat.flow("0000");
