...
public class Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_9_Test  extends TestBase {
    Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_9
            Etisalat;

    @Test
    public void  Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_9()  throws  Exception
    {
        try {
        Etisalat = new Etisalat_Akwa_Kart_fe_Misr_MIX_lkol_el4abakat_9(driver);
