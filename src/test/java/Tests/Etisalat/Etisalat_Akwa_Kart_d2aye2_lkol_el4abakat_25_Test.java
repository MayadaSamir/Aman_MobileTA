...
public class Etisalat_Akwa_Kart_d2aye2_lkol_el4abakat_25_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_25_page EtisalatDayaye2 ;

    @Test
    public  void   Etisalat_Akwa_Kart_fe_Misr_d2aye2_25 () throws Exception
    {
        try {
            EtisalatDayaye2 = new Etisalat_Akwa_Kart_fe_Misr_d2aye2_lkol_el4abakat_25_page(driver);
            ...
            Assert.assertEquals(EtisalatDayaye2.AmountVALUE.getText(), "EGP 25.0");
            Assert.assertEquals(EtisalatDayaye2.Totalvalue.getText(), "EGP 25.0");
