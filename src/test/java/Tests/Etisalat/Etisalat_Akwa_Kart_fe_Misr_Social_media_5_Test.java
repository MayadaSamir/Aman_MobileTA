...
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_Social_media_4_25_page;
import Pages.Etisalat.Etisalat_Akwa_Kart_fe_Misr_Social_media_5_page;
import Tests.TestBase;
import org.testng.Assert;
import org.testng.annotations.Test;

public class Etisalat_Akwa_Kart_fe_Misr_Social_media_5_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_Social_media_5_page
            Etisalat;
    ...
    {
        try {
            Etisalat = new Etisalat_Akwa_Kart_fe_Misr_Social_media_5_page(driver);
            ...
            Assert.assertTrue(Etisalat.AmountVALUE.getText().contains("5"));
            Assert.assertTrue(Etisalat.Totalvalue.getText().contains("5"));
            Etisalat.flow("0000");
