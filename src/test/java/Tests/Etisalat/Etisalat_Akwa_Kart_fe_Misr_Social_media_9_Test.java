...
public class Etisalat_Akwa_Kart_fe_Misr_Social_media_9_Test extends TestBase {

    Etisalat_Akwa_Kart_fe_Misr_Social_media_9_page Etisalat;

    @Test
    public void Etisalat_Akwa_Kart_fe_Misr_social_media_9 () throws Exception
    {
        try {
            Etisalat = new Etisalat_Akwa_Kart_fe_Misr_Social_media_9_page(driver);
