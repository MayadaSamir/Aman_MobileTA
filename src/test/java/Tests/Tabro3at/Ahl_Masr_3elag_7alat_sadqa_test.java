...
public class Ahl_Masr_3elag_7alat_sadqa_test extends TestBase {
    Ahl_Masr_3elag_7alat_sadqa halatObj;
    ...
    public void Test()  throws Exception
    {
        try
        {
            halatObj= new Ahl_Masr_3elag_7alat_sadqa(driver);
