...
public class Ahl_Masr_tabro3_3am_zakah_test extends TestBase {

    Ahl_Masr_tabro3_3am_zakah tabro3Obj;

    @Test
    public void Test() {
        tabro3Obj= new Ahl_Masr_tabro3_3am_zakah(driver);
